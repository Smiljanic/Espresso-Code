...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(top_srcdir)/src/python/pypresso.in COPYING \
...
am__aclocal_m4_deps = $(top_srcdir)/config/Espresso.m4 \
	...
	$(top_srcdir)/config/ax_boost_unit_test_framework.m4 \
	$(top_srcdir)/config/ax_count_cpus.m4 \
	$(top_srcdir)/config/ax_cxx_compile_stdcxx_11.m4 \
	$(top_srcdir)/config/ax_cxx_var_prettyfunc.m4 \
...
CONFIG_CLEAN_FILES = src/python/pypresso
...
ECHO_T = 
EGREP = /bin/grep -E
ESPRESSO_MPIEXEC = /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb/tools/es_mpiexec
EXEEXT = 
FGREP = /bin/grep -F
GREP = /bin/grep
HAVE_CXX11 = 1
...
MYMPIEXEC = /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb/mympiexec.sh
NM = /usr/bin/nm -B
NMEDIT = 
NVCC = no
...
PACKAGE_STRING = ESPResSo 3.4-dev-1521-g09ec05f
PACKAGE_TARNAME = espresso
PACKAGE_URL = 
PACKAGE_VERSION = 3.4-dev-1521-g09ec05f
PATH_SEPARATOR = :
PDFLATEX = /usr/bin/pdflatex
POW_LIB = 
PYTHON = /usr/bin/python
PYTHONCONFIG = /usr/bin/python2.7-config
PYTHON_CPPFLAGS = -I/usr/include/python2.7 -I/usr/include/x86_64-linux-gnu/python2.7  -fno-strict-aliasing -D_FORTIFY_SOURCE=2 -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -I/usr/lib/python2.7/dist-packages/numpy/core/include
PYTHON_EXEC_PREFIX = ${exec_prefix}
PYTHON_EXTRA_LDFLAGS = 
PYTHON_EXTRA_LIBS = -lpthread -ldl  -lutil -lm  -lpython2.7
PYTHON_LDFLAGS = -L/usr/lib/python2.7/config-x86_64-linux-gnu -L/usr/lib -lpthread -ldl  -lutil -lm  -lpython2.7 -Xlinker -export-dynamic -Wl,-O1 -Wl,-Bsymbolic-functions
...
SHELL = /bin/bash
STRIP = strip
VERSION = 3.4-dev-1521-g09ec05f
XMKMF = 
X_CFLAGS = 
X_EXTRA_LIBS = 
X_LIBS = 
X_PRE_LIBS = 
abs_builddir = /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb
abs_srcdir = /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb
abs_top_builddir = /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb
abs_top_srcdir = /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = mpic++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/itvms/PHD/CODE/Espresso-Rudolf/espresso-gb/config/install-sh
...
SUBDIRS = config src . $(am__append_1) tools testsuite doc
...
# Handle version
EXTRA_DIST = bootstrap.sh samples packages $(extra) version.txt
...
$(am__aclocal_m4_deps):
src/python/pypresso: $(top_builddir)/config.status $(top_srcdir)/src/python/pypresso.in
