...
#      continue}
     puts $f [part $i print pos quat type]}
  }
#}
...
for {set i 1} {$i <$nx} {incr i} {
  part [setmd n_part] pos [expr 25+$sigma3 * $i] 25 25 quat 1 0 0 0 mass 1
}

for {set i 1} {$i <$nz} {incr i} {
  part [setmd n_part] pos 25 25 [expr 25+$sigma3 * $i ] quat 1 0 0 0 mass 1 
}

#puts "Observable gives the distance to the specified particle"
