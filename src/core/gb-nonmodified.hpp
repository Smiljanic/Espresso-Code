...
// evaluate mutual position
 ...
 pos_1[2]=p2->r.p[2];
  ...
  double a,b,c, X, Xcut,
    ...
    u1x = p1->r.quatu[0]; u1y = p1->r.quatu[1]; u1z = p1->r.quatu[2]; /* director of particle 1 */
    u2x = p2->r.quatu[0]; u2y = p2->r.quatu[1]; u2z = p2->r.quatu[2]; /* director of psrticle 2 */
    ...
    Sigma = ia_params->GB_sig1/sqrt(1-0.5*Brhi1);
